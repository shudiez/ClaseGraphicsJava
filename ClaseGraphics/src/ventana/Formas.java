...
public class Formas extends javax.swing.JFrame {
    ...
    public void paint(Graphics g){
        ...
        //Metodo para stablecer color
        g.setColor(Color.BLUE);
        //Metodo para dibujar linea recta
        g.drawLine(0, 70, 100, 70);
        //Metodo para dibujar un rectangulo
        g.drawRect(150, 70, 50, 70);
        //Metodo para dibujar rectangulo con bordes redondeados
        g.drawRoundRect(250, 70, 50, 70, 6, 6);
        //Metodo para dibujar un ovalo
        g.drawOval(350, 70, 50, 70);
        
        //crecacion de vectores para poder dibujar un triangulo
        int vectorX [] = {500, 550, 450};
        int vectory [] = {70, 120, 120};
        //Coordenadas
        g.drawPolygon(vectorX, vectory, 3);
        
        //metodos para rellenar
